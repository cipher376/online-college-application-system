...
<div class="panel panel-color panel-info" ng-controller="AcademicBackgroundController" id="alevel-form">
    <div class="progress">
        <div role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 10%;" class="progress-bar progress-bar-info progress-bar-striped active" sytle="font-weight:bolder">10%</div>
        ...
        <div role="progressbar" aria-valuenow="60" aria-valuemin="0" aria-valuemax="100" style="width: 15%;" class="progress-bar progress-bar-success progress-bar-striped active">15%</div>
    </div>
    ...
    <div class="panel-body">
        ...
        <form class="form-horizontal p-20" role="form" name="alevelinfo">
                        ...
                        <div class="portlet">
                            <div class="portlet-heading bg-warning">
                                ...
                                <div class="portlet-widgets">
                                    <a href="javascript:;" data-toggle="reload"><i class="ion-refresh"></i></a>
                                    <span class="divider"></span>
                                    <a data-toggle="collapse" data-parent="#accordion1" href="#alevel"><i class="ion-minus-round"></i></a>
                                    <span class="divider"></span>

                                </div>
                                <div class="clearfix"></div>
                            </div>
                            <div id="alevel" class="panel-collapse collapse in">
                                <div class="portlet-body">
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">Examination ID</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" required=""
                                                   ng-model="alevel.centerno" placeholder="Center Number">
                                        </div>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" required=""
                                                   ng-model="alevel.index" placeholder="Index Number">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-4 control-label">General Paper</label>
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                <datepicker date-format='yyyy-MM-dd'>
                                                    <input class="form-control" required=""
                                                           ng-model="alevel.core1.date" placeholder="Date Taken" type="text"/>
                                                </datepicker>
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <select required="" class="form-control" ng-model="alevel.core1.grade">
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control" 
                                                           ng-model="alevel.elect1.name" placeholder="Subject Name">
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div class="input-group">
                                                <datepicker date-format='yyyy-MM-dd'>
                                                    <input class="form-control" required=""
                                                           ng-model="alevel.elect1.date" placeholder="Date Taken" type="text"/>
                                                </datepicker>
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                            </div>
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <select required="" class="form-control" ng-model="alevel.elect1.grade">
                                                <option value="">Grade</option>
                                                <option value="A1">A1</option> 
                                                <option value="B2">B2</option> 
                                                <option value="B3">B3</option>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control" 
                                                           ng-model="alevel.elect2.name" placeholder="Subject Name">
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div class="input-group">
                                                <datepicker date-format='yyyy-MM-dd'>
                                                    <input class="form-control" required=""
                                                           ng-model="alevel.elect2.date" placeholder="Date Taken" type="text"/>
                                                </datepicker>
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <select required="" class="form-control" ng-model="alevel.elect2.grade">
                                                <option value="">Grade</option>
                                                <option value="A1">A1</option> 
                                                <option value="B2">B2</option> 
                                                <option value="B3">B3</option>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control" 
                                                           ng-model="alevel.elect3.name" placeholder="Subject Name">
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div class="input-group">
                                                <datepicker date-format='yyyy-MM-dd'>
                                                    <input class="form-control" required=""
                                                           ng-model="alevel.elect3.date" placeholder="Date Taken" type="text"/>
                                                </datepicker>
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            ...
                                            <select required="" class="form-control" ng-model="alevel.elect3.grade">
                                                <option value="">Grade</option>
                                                <option value="A1">A1</option> 
                                                <option value="B2">B2</option> 
                                                <option value="B3">B3</option>
                                    ...
                                    <!---------************ Resit A-Level Subjects =------------------------>
                                    <div class="form-group">
                                        <label class="col-sm-12 control-label" style="text-align: center">Resit Subjects(Optional)</label>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control"
                                                   ng-model="alevel.resit1.centerno"placeholder="Center Number">
                                        </div>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control"
                                                   ng-model="alevel.resit1.index"placeholder="Index Number">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control"
                                                           ng-model="alevel.resit1.name" placeholder="Subject Name">
                                                </div>
                                            </div>
                                            ...
                                            <div class="input-group">
                                                <datepicker date-format='yyyy-MM-dd'>
                                                    <input class="form-control"
                                                           ng-model="alevel.resit1.date" placeholder="Date Taken" type="text"/>
                                                </datepicker>
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <select class="form-control" ng-model="alevel.resit1.grade">
                                                <option value="">Grade</option>
                                                <option value="A1">A1</option> 
                                                <option value="B2">B2</option> 
                                                <option value="B3">B3</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control"
                                                   ng-model="alevel.resit2.centerno" placeholder="Center Number">
                                        </div>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control"
                                                   ng-model="alevel.resit2.index" placeholder="Index Number">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control"
                                                           ng-model="alevel.resit2.name" placeholder="Subject Name">
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                <datepicker date-format='yyyy-MM-dd'>
                                                    <input class="form-control" 
                                                           ng-model="alevel.resit2.date" placeholder="Date Taken" type="text"/>
                                                </datepicker>
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <select  class="form-control" ng-model="alevel.resit2.grade">
                                                <option value="">Grade</option>
                                                <option value="A1">A1</option> 
                                                <option value="B2">B2</option> 
                                                <option value="B3">B3</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control"
                                                   ng-model="alevel.resit3.centerno" placeholder="Center Number">
                                        </div>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" 
                                                   ng-model="alevel.resit3.index"  placeholder="Index Number">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="col-sm-4">
                                            <div class="form-group">
                                                <div class="col-sm-12">
                                                    <input type="text" class="form-control"
                                                           ng-model="alevel.resit3.name" placeholder="Subject Name">
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-4">
                                            <div class="input-group">
                                                <datepicker date-format='yyyy-MM-dd'>
                                                    <input class="form-control" 
                                                           ng-model="alevel.resit3.date" placeholder="Date Taken" type="text"/>
                                                </datepicker>
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-calendar"></i></span>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                            <select  class="form-control" ng-model="alevel.resit3.grade">
                                                <option value="">Grade</option>
                                                <option value="A1">A1</option> 
                                                <option value="B2">B2</option> 
                                                <option value="B3">B3</option>
...
<div class="form-group"> 
    ...
    <div class="col-sm-6 " >
        <button type="button" class="btn btn-success w-lg m-b-5" id='next-btn' ng-click="nextclick($event, alevelinfo.$valid)">Next</button>
    </div>
...
<script>
            ...
            jQuery('#alevel-core').datepicker();
            jQuery('#alevel-sub1').datepicker();
            jQuery('#alevel-sub2').datepicker();
            jQuery('#alevel-sub2').datepicker();
