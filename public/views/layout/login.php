            ...
            <div class="wrap-login100">
                ...
                <form  id="login" class="login100-form validate-form" name="loginForm" method="post" class="ng-cloak">
                    ...
                    <div class="wrap-input100 validate-input" data-validate = "Enter username">
                        <input class="input100" placeholder="Email" name="loginemail" class="mail" type="email" required="" minlength="5"
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Enter password">
                        <input class="input100"  placeholder="Password" name="loginpassword" class="pass" type="password" 
                        required="" ng-model="account.user.password" minlength="6">
                        <span class="focus-input100" data-placeholder="&#xf191;"></span>
                    </div>

                    <div class="contact100-form-checkbox">
                        <input class="input-checkbox100" ng-model="account.user.remember" id="ckb1" type="checkbox" name="remember-me">
                    ...
                    <div class="container-login100-form-btn">
                        <button class="login100-form-btn" type="submit" value="go to application"   ng-click="login()">
                            Login
                        </button>
                    </div>

                    <div class="text-center p-t-60 change-reg">
                        <a class="txt1 mr-20" id="login-register" class="change-log" ng-click="changeLog()">
                            Register   | 
                        </a> 
                        <a class="txt1" href="/Auth/PasswordReset">
                            Forgot Password?
                        </a>
                        <div class="row text-center">
                            <p class="row text-center small" style="text-align: center">For any enquiries, call the admission desk <span class="fa fa-phone"></span>  0201742690 \ 0241605585</p>
                    ...
                    <form id="register" class="login100-form validate-form" class="ng-cloak" name="registerform" method="post">
                        <span class="login100-form-logo">
                            <a href="http://www.anuc.edu.gh" target="_blank"style="padding: 7%;margin-top: 7%;margin-right: 2%;">
                                <img src="/public/assets/images/anulogo.png" 
                                height="100px" width="100px" style="padding: 10%;">
                        ...
                        <div class="wrap-input100 validate-input" data-validate = "Enter username">
                            <input class="input100" placeholder="Email" name="regemail" class="mail" type="email" required="" minlength="5"
                            ng-model="account.user.email">
                            <span class="focus-input100" data-placeholder="&#xf207;"></span>

                        </div>
                        <div class="wrap-input100 validate-input"  data-validate="Enter password">
                            <input class="input100" placeholder="Password" name="regpassword"  class="pass" 
                            type="password" required="" ng-model="account.user.password" minlength="6">
                            <span class="focus-input100" data-placeholder="&#xf191;"></span>

                        </div>

                        <div class="wrap-input100 validate-input" data-validate="Enter password">
                            <input class="input100"  placeholder="Confirm Password" type="password" name="conregpassword" class="pass" required="" ng-model="account.user.confirmpassword" minlength="6">
                            <span class="focus-input100" data-placeholder="&#xf191;"></span>
                        </div>

                        <div class="container-login100-form-btn">
                            <button type="submit"  class="login100-form-btn"  value="Register"   ng-click="register()">
                                Register
                            </button>
                        </div>

                        <div class="text-center p-t-60 change-reg">
                            <a id="register-login" class="txt1 mr-20" class="change-reg" ng-click="changeReg()">
                                Login   | 
                            </a> 
                            <a class="txt1" href="/Auth/PasswordReset">
                                Forgot Password?
